<template>
  <div class="home">
    ...
    <section class="aboutMe">
      <!-- Space Images On The Background -->
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="info">
                ...
                <div class="way">
                  <h4>Mail Me</h4>
                  <i class="fas fa-at" /> <span>7assan.3li1998@gmail.com</span>
                </div>
                <div class="way">
                  <h4>Call Me</h4>
                  <i class="fas fa-phone" /> <span>+201146321817</span>
                </div>
                <div class="icons">
            ...
            <div class="col-md-7 col-12">
              <div class="form">
                ...
                <textarea v-model="message" cols="30" rows="6" placeholder="Type your message..." />
